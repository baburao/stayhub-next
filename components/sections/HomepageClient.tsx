...
const TESTIMONIALS_AR = [
  ...
  { quote: 'مزامنة جاذر إن + Airbnb وحدها أنقذتنا من 12 حجزاً مزدوجاً في الشهر الأول. رائع.', name: 'سارة الغامدي', role: 'مضيفة، أبها', rating: 5 },
...
const FAQS_AR = [
  ...
  { q: 'ما قنوات OTA التي يدعمها StayHub؟', a: 'ندعم Airbnb وBooking.com وAgoda وExpedia وGoogle Vacation Rentals وجاذر إن وAJAAR — مع إضافة منصات جديدة بانتظام.' },
