...
const integrationsList = [
  ...
  },
  {
    ...
    metaDescription:
      'List your short-term rentals on AQAR and manage availability, pricing, and inquiries from StayHub. Reach millions of Saudi renters from one dashboard.',
    badge: 'OTA Integration',
    h1: 'AQAR Integration',
    arabicH1: 'تكامل مع عقار',
    subtitle: 'Publish your listings to AQAR and sync availability, pricing, and leads back into StayHub automatically.',
    color: '#1B5E93',
    stats: [
      { value: '#1', label: 'Real estate platform in KSA' },
      { value: 'Millions', label: 'Monthly Saudi visitors' },
      { value: 'Auto', label: 'Lead & calendar sync' },
    ],
    painPoints: [
      { title: 'Manual Listing Updates', desc: 'Re-posting and editing AQAR listings by hand wastes hours and goes stale fast.' },
      { title: 'Scattered Leads', desc: 'AQAR inquiries land outside your workflow and slip through the cracks.' },
      { title: 'Calendar Drift', desc: 'Availability on AQAR falls out of sync with your other channels, risking double bookings.' },
    ],
    benefits: [
      { title: 'Auto-Published Listings', desc: 'Push property details, photos, and pricing to AQAR straight from StayHub.' },
      { title: 'Unified Lead Inbox', desc: 'Every AQAR inquiry flows into your StayHub inbox with the rest of your channels.' },
      { title: 'Real-Time Availability', desc: 'Calendar updates sync to AQAR instantly to prevent double bookings.' },
      { title: 'Dynamic Pricing', desc: 'Apply demand-based rates to your AQAR listings automatically.' },
      { title: 'Centralized Reporting', desc: 'See AQAR performance alongside every other channel in one analytics view.' },
    ],
    workflowSteps: [
      { step: 1, title: 'Connect AQAR', desc: 'Link your AQAR account to StayHub in minutes.' },
      { step: 2, title: 'Publish Listings', desc: 'Push your properties to AQAR with full details.' },
      { step: 3, title: 'Sync 24/7', desc: 'Calendar and pricing stay in sync automatically.' },
      { step: 4, title: 'Manage Centrally', desc: 'Handle AQAR leads and bookings from StayHub.' },
    ],
    relatedIntegrations: ['gathern', 'airbnb', 'booking-com'],
    faq: [
      { q: 'How does StayHub connect to AQAR?', a: 'StayHub publishes your listings to AQAR and syncs availability, pricing, and inquiries back into your dashboard so you manage everything in one place.' },
      { q: 'Will my AQAR calendar stay in sync?', a: 'Yes. Availability changes propagate to AQAR in real time, keeping it aligned with Airbnb, Booking.com, Gathern, and your other channels.' },
      { q: 'Can I handle AQAR leads inside StayHub?', a: 'Yes. AQAR inquiries appear in the StayHub unified inbox so nothing slips through.' },
    ],
  },
  {
    slug: 'ejar-ota',
